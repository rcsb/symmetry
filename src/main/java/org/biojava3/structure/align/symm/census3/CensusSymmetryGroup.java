...
/**
 * The space group of a symmetric structure.
 * 
 * @author dmyersturnbull
 */
public class CensusSymmetryGroup implements Serializable, Comparable<CensusSymmetryGroup> {
	...
	public CensusSymmetryGroup() {

	}

	public CensusSymmetryGroup(String group) {
		super();
		this.group = group;
	}

	@Override
	public int compareTo(CensusSymmetryGroup o) {
	...
	public boolean equals(Object obj) {
		...
		CensusSymmetryGroup other = (CensusSymmetryGroup) obj;
		if (group == null) {
	...
	/**
	 * @return Whether this info has <em>rotational or true helical</em>
	 *         symmetry and its order of symmetry is an even number.
	 */
	...
	/**
	 * @return Whether this info <em>has helical but not</em> rotational
	 *         symmetry.
	...
	/**
	 * @return Whether this info has helical symmetry for which the symmetry
	 *         operation must be applied a fractional number of times to result
	 *         in the trivial alignment.
	 *         <em>This includes superhelical and non-integral order helical symmetry.</em>
	 */
	...
	/**
	 * @return Whether this info has <em>rotational or true helical</em>
	 *         symmetry and its order of symmetry is an odd number.
	 */
	...
	/**
	 * @return Whether this info has a "bent" or curved helical symmetry, such
	 *         as that of a screw that is bent around in a curve.
	 */
	...
	/**
	 * @return Whether this info <em>has translational but not</em> rotational
	 *         symmetry.
	 */
	...
	/**
	 * @return Whether this info
	 *         <em>has <strong>true</strong> helical symmetry</em>. This
	 *         <em>does not</em> include superhelical or non-integral order
	 *         helical symmetry.
	 */
