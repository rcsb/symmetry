...
public class AligQuaternaryStructure {
	...
	public double[] align(String pdbId1, String pdbId2) {
		...
		SequenceClusterer grouper1 = new GlobalSequenceGrouper(s1, MIN_SEQUENCE_LENGTH);

		Structure s2 = getStructure(pdbId2);
		if (s2 == null) {
			return bestRmsd;
		}
		SequenceClusterer grouper2 = new GlobalSequenceGrouper(s2, MIN_SEQUENCE_LENGTH);
...
//		writer.writeTransformedStructure(identity, fileName);
	...
	private double[] quaternaryStructureAlignment(List<Integer> mapping, ClusterAlignment alignment, SequenceClusterer grouper1, SequenceClusterer grouper2, Matrix4d transformation) {
