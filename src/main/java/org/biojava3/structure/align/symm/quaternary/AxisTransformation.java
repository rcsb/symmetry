...
//		Vector3d[] axes = getPrincipalAxesOfInertia();
//
...
//
//			s.append(JmolScriptGenerator.getSymmetryAxis(i*100, direction, rotationGroup.getPointGroup(), rotation.getFold(), getPrincipalRotationAxis(),getRotationReferenceAxis(), radius, diameter, color, center, axis));
//
//		}
//		return s.toString();
//	}
...
//		s.append(JmolScriptGenerator.getJmolWirePolyhedron(100, p, calcPrismTransformation()));
//		s.append("delay ");
//		s.append(delay); 
//		s.append(";");
//
...
//		p.setHeight(getZRadius()*2);
//		p.setInscribedRadius(getXYRadius());
//		s.append(JmolScriptGenerator.getJmolWirePolyhedron(100, p, getReverseTransformation()));
//		s.append("delay ");
//		s.append(delay); 
//		s.append(";");
//
...
//		s.append(JmolScriptGenerator.getJmolWirePolyhedron(100, t, getReverseTransformation()));
//		s.append("delay ");
//		s.append(delay); 
//		s.append(";");
//
...
//		s.append(JmolScriptGenerator.getJmolWirePolyhedron(100, o, getReverseTransformation()));
//		s.append("delay ");
//		s.append(delay); 
//		s.append(";");
//
