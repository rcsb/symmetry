...
public class SubunitMapper {
	...
	private List<Integer> getMappingByStructuralSuperposition() {
		...
		SequenceClusterer seqGroup1 = new GlobalSequenceGrouper(structure1, MIN_SEQUENCE_LENGTH);
		List<Atom[]> cas1 = seqGroup1.getCalphaTraces();
		SequenceClusterer seqGroup2 = new GlobalSequenceGrouper(structure2, MIN_SEQUENCE_LENGTH);
...
//		vectors[2] = null;
	...
	private FindQuarternarySymmetry getQuaternarySymmetry(Structure structure) {
		SequenceClusterer seqGroup = new GlobalSequenceGrouper(structure, MIN_SEQUENCE_LENGTH);
