...
public class SymmRefinerTest extends TestCase {
	...
	public void testExpected() throws StructureException {
		...
		for(int i=0;i<alignments.size(); i++) {
			...
			Map<Integer, Integer> refined = SingleAlignRefiner.refineSymmetry(align, 3);
	...
	public void testAutomorphism() throws StructureException {
		for(int i=0;i<alignments.size(); i++) {
			...
			Map<Integer,Integer> refined = SingleAlignRefiner.refineSymmetry(align,orders.get(i));
	...
	public void testSymmetric() throws StructureException {
		for(int i=0;i<alignments.size(); i++) {
			...
			Map<Integer, Integer> refined = SingleAlignRefiner.refineSymmetry(align, order);
