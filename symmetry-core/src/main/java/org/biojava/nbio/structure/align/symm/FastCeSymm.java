...
public class FastCeSymm {
	...
	private CESymmCalculator calculator;
	...
	public CESymmCalculator getCalculator() {
		return calculator;
	}

	public void setCalculator(CESymmCalculator calculator) {
	...
	protected AFPChain align(Atom[] ca10, Atom[] ca2O, Object param)
		...
		calculator = new CESymmCalculator(params);
